new StructureFeatureConfiguration(new ResourceLocation("${modid}:${field$structure}"), ${field$random_rotation?lower_case}, ${field$random_mirror?lower_case}, ImmutableList.of(${input$ignored_blocks?replace(",", ".getDefaultState(),")}.getDefaultState()), new Vector3i(
